...
allowed_group_id = -1002599678170
#dont modify coded by bonummaster
...
def handle_non_group_message(message):
    bot.reply_to(message, text='𝐵𝑜𝑡 𝑜𝑛𝑙𝑦 𝑤𝑜𝑟𝑘 𝑖𝑛 : https://t.me/+nxovq9NVbFFkODBl')
